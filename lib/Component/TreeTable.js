...
var TreeTable = function (_Component) {
    ...
    _createClass(TreeTable, [{
            ...
            if (fixedLeftRow || fixedRightHeadRow) {
                ...
                for (var _i = 0; _i < tbody.length; _i++) {
                    ...
                    if (ltbody && ltbody[_i]) {
                        ...
                        ltbody[_i].style.minHeight = height;
                    }
                    if (rtbody && rtbody[_i]) {
                        rtbody[_i].style.height = height;
                        rtbody[_i].style.minHeight = height;
                    }
                }
            }
        }
        ...
        key: 'colgroupRender',
        value: function colgroupRender(data) {
            var output = [];
        ...
        key: 'rowsRender',
        value: function rowsRender(cols) {
            var _this4 = this;
        ...
        key: 'bodyRender',
        value: function bodyRender(height) {
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'colgroup',
                        { ref: 'colgroup' },
                        this.colgroupRender(this.columnData)
                    ),
                    _react2.default.createElement(
                        'tbody',
                        { ref: 'tbody' },
                        this.rowsRender(this.columnData)
                    )
                )
            );
        }
        ...
        key: 'leftBodyRender',
        value: function leftBodyRender(height) {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'colgroup',
                            { ref: 'left' },
                            this.colgroupRender(this.leftColumnData)
                        ),
                        _react2.default.createElement(
                            'tbody',
                            { ref: 'ltbody' },
                            this.rowsRender(this.leftColumnData)
                        )
                    )
                );
            }
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'colgroup',
                            { ref: 'right' },
                            this.colgroupRender(this.rightColumnData)
                        ),
                        _react2.default.createElement(
                            'tbody',
                            { ref: 'rtbody' },
                            this.rowsRender(this.rightColumnData)
                        )
                    )
                );
            }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    !!this.leftColumnData.length && _react2.default.createElement(
                        'div',
                        { className: "table-tree table-fixed table-left-fixed " + lineWrap },
                        _react2.default.createElement(
                            _TreeHeader2.default,
                            {
                    ...
                    !!this.rightColumnData.length && _react2.default.createElement(
                        'div',
                        { className: "table-tree table-fixed table-right-fixed " + lineWrap },
                        _react2.default.createElement(
                            _TreeHeader2.default,
                            {
