...
var TreeTable = function (_Component) {
    ...
    _createClass(TreeTable, [{
        ...
        key: 'rowsRender',
        value: function rowsRender(cols, hideSelectRow, right) {
            var _this4 = this;
            ...
            var noTextData = _props6.noTextData;
            ...
            renderedList.forEach(function (node) {
                ...
                output.push(_react2.default.createElement(_TreeRow2.default, {
                    ...
                    onMouseOver: hover ? _this4.handleHover.bind(_this4, key) : function () {},
                    onMouseOut: hover ? _this4.handleHover.bind(_this4, null) : function () {},
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'tbody',
                            { ref: 'rtbody' },
                            this.rowsRender(this.rightColumnData, true, true)
                        )
                    )
                );
            }
            ...
            if (pagination) {
                return _react2.default.createElement(
                    ...
                    remote ? _react2.default.createElement(_Pagination2.default, {
                        ...
                        startLabel: options.startLabel,
                        paginationSize: options.paginationSize,
                        dataSize: isTree ? this.state.dictionary.length : this.props.data.length,
...
TreeTable.defaultProps = {
    ...
    noTextData: _react2.default.createElement(
        'span',
        null,
        '暂无数据'
    ),
...
TreeTable.propTypes = {
    ...
    noTextData: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number, _react.PropTypes.node, _react.PropTypes.func, _react.PropTypes.element]),
