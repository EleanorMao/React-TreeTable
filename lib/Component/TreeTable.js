        ...
        value: function bodyRender() {
            ...
            renderedList.forEach(function (node) {
                output.push(_react2.default.createElement(_TreeRow2.default, {
                    ...
                    data: node,
                    open: node.__opened,
                    dataFormat: _this3.props.dataFormat,
        ...
        value: function pagingRender() {
            ...
            if (pagination) {
                return _react2.default.createElement(
                    'div',
                    { className: 'fr' },
                    remote ? _react2.default.createElement(_Pagination2.default, { dataSize: dataSize, sizePerPage: options.sizePerPage, current: options.page, onPageChange: options.onPageChange }) : _react2.default.createElement(_Pagination2.default, { dataSize: this.state.dictionary.length, sizePerPage: options.sizePerPage, current: this.state.crtPage, onPageChange: this.handleClick.bind(this) })
                );
            }
        }
    }, {
