...
var TreeTable = function (_Component) {
    ...
    _createClass(TreeTable, [{
        ...
        value: function render() {
            ...
            var iskey = _props5.iskey;
            var isTree = _props5.isTree;
            var remote = _props5.remote;
            var height = _props5.height;
            var hashKey = _props5.hashKey;
            var options = _props5.options;
            var children = _props5.children;
            var sortName = _props5.sortName;
            var selectRow = _props5.selectRow;
            var sortOrder = _props5.sortOrder;
            var nestedHead = _props5.nestedHead;
