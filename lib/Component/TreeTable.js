...
var TreeTable = function (_Component) {
    ...
    _createClass(TreeTable, [{
        ...
        value: function _adjustWidth() {
            ...
            var haveScrollBar = this.refs.tbody.parentNode.offsetWidth !== this.refs.header.offsetWidth;
        ...
        value: function colgroupRender() {
            var output = [];
            this.columnDate.map(function (item, index) {
                var style = {
                    width: item.width,
                    minWidth: item.width,
        ...
        value: function bodyRender() {
            ...
            var startArrowCol = _props3.startArrowCol;
