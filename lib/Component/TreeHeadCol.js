        ...
        value: function caretRender(dataField, sortName, sortOrder) {
            ...
            var SortGroup = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "span",
                    { className: "dropdown" },
                    _react2.default.createElement("span", { className: "caret", onClick: function onClick() {
                            return _this2.props.onSort(dataField, 'desc');
                        },
                ...
                _react2.default.createElement(
                    ...
                    { className: "dropup" },
                    _react2.default.createElement("span", { className: "caret", onClick: function onClick() {
                            return _this2.props.onSort(dataField, 'asc');
                        },
                        style: { margin: '10px 0', color: '#ccc' } })
                )
            );
            var AscCaret = _react2.default.createElement("span", { className: "caret",
                onClick: function onClick() {
                    return _this2.props.onSort(sortName, sortOrder === 'desc' ? 'asc' : 'desc');
                },
