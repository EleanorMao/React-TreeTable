    ...
    _createClass(TreeHeader, [{
        ...
        value: function colgroupRender(renderChildren, selectRow, isTree, left, right) {
            ...
            return _react2.default.createElement(
                'colgroup',
                { ref: 'colgroup' },
                selectRow.mode !== 'none' && !selectRow.hideSelectRow && !isTree && _react2.default.createElement('col', { key: 'select', style: { textAlign: 'center', width: 30 } }),
        ...
        value: function render() {
            ...
            var i = 0;
            var renderChildren = (0, _Util.sort)(children).sorted;
            return _react2.default.createElement(
                'div',
