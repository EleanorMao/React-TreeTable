...
var TreeRow = function (_Component) {
    ...
    function TreeRow(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TreeRow).call(this, props));
    ...
    _createClass(TreeRow, [{
        ...
        value: function handleToggle(event) {
            var data = _extends({}, { display: this.state.open }, { data: this.props.data });
            ...
            this.props.cols.map(function (key, i, col) {
                ...
                output.push(_react2.default.createElement(
                    ...
                    { className: 'table-cell',
                        style: { width: key.width || _this2.props.width },
