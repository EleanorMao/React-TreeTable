...
var TreeRow = function (_Component) {
    ...
    _createClass(TreeRow, [{
        ...
        value: function cellRender() {
            ...
            var colIndex = _props2.colIndex;
            var selectRow = _props2.selectRow;
            var showTitle = _props2.showTitle;
            ...
            cols.map(function (key, i, col) {
                ...
                output.push(_react2['default'].createElement(
                    ...
                    { style: style,
                        ...
                        title: typeof showTitle === 'boolean' ? ~['string', 'number'].indexOf(typeof cell === 'undefined' ? 'undefined' : _typeof(cell)) ? cell : null : typeof showTitle === 'function' ? showTitle(cell, data[key.id], level, data) : null
                    },
