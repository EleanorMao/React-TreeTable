...
var TreeRow = function (_Component) {
    ...
    _createClass(TreeRow, [{
        ...
        value: function cellRender() {
            ...
            var key = hashKey ? data.__uid : data[iskey];
            if (isSelect) {
                output.push(_react2.default.createElement(
                    'td',
                    { key: key, style: { backgroundColor: checked && selectRow.bgColor, textAlign: 'center' } },
            ...
            cols.map(function (key, i, col) {
                ...
                var showArrow = isTree && key.showArrow.call(null, data[key.id], level, data, i, col);
                output.push(_react2.default.createElement(
                    'td',
                    { style: style,
                        key: '' + key + i
                    ...
                    _react2.default.createElement(
                        ...
                        cell,
                        showArrow && !!children && !arrow && _react2.default.createElement(
                            'i',
                            {
